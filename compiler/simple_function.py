#!/usr/bin/env python3
"""
Script to generate bytecode for a simple function test
"""
...
# Generate bytecode for a simple function test
bytecode = [
    # Push a string
    ...
    # Define a function 'add' that returns x + y (with missing semicolon)
    ...
    OpCode.JUMP, 13, 0, 0, 0,  # Jump to position 33
    ...
    # Main program continues here (position 30)
    # Push a string
...
# Names (strings)
names = [
    "Testing a simple function with missing semicolon...",  # String index 0
    "add",                                                 # Function name (index 1)
    "x",                                                   # Parameter 1 (index 2)
    "y",                                                   # Parameter 2 (index 3)
    "Calling add(7, 8):"                                   # String index 4
]

# Write bytecode to a file
with open("simple_function.bytecode", "wb") as f:
    # Write bytecode
...
print("Bytecode written to simple_function.bytecode")
